package dev.vavelin.treelock.jdbc
 ...
 * There is also treelock-benchmark (based on jmh) project which completes that integration test with more
...
class JDBCSimpleKeyLockTest extends Specification {
    ...
    def setup() {
        ...
        // let's purge LCK table just to be sure nothing interferes with the test suit
        dataSource.connection.prepareStatement("DELETE FROM LCK").executeUpdate()
    }
