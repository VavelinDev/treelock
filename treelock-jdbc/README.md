Much has been already covered by the main **treelock** README file.
And here is the main implementation of **treelock** library.
JDBC API is the main focus of the **treelock** library.
However, _treelock-api_ and _treelock-core_ stay open for any other, repository-based concretization. 
